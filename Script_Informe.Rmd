...
```{r echo=FALSE}
# Carga de datos
setwd("C:\\Users\\`\\Desktop\\Semestre 2024-1\\Seminario de Estadistica\\Tarea 2\\Ejercicio 3")
options(digits=4)
...
La escala numerica es la siguiente: 1 = *Disagree strongly*; 2 = *Disagree a little* ; 3 = *Neither agree nor disagree*;
...
fviz_eig(R.CP) # Mostrará cuantos componentes principales explican la mayor parte del modelo, en este caso, son 4 componentes principales los que explican la mayor parte del modelo. 
